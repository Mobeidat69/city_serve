    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="card p-3 py-4">
                ...
                <div class="text-center mt-3">
                    ...
                    <div class="px-3">
                <a href="{{ $profile->github }}" class="pt-3 pb-3 pr-3 pl-0 underline-none"><span class="icon-facebook"></span></a>
                <a href="{{ $profile->linkedin }}" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-twitter"></span></a>
            </div>
