        ...
        <div class="col-lg-4">
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
              ...
              <li class="mb-2"><strong class="text-black">Employment Status:</strong> {{$job->job_title}}</li>
          ...
          <div class="bg-light p-3 border rounded">
            ...
            <div class="px-3">
              <a href="https://www.facebook.com/sharer/sharer.php?url='',{{route('single.job',$job->id)}}&quote={{$job->job_title}}" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-facebook"></span></a>
